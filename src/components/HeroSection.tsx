          ...
          <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  className="uppercase px-10 font-semibold py-5 text-sm shadow-xs bg-yellow-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                >
                  discover more
                </a>
                {/* <a href="#" className="text-sm/6 font-semibold text-yellow-400">
